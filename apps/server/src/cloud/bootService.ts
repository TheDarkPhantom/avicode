...
/**
 * Installs Avi Code as a per-user boot service. Linux-only for now: systemd
...
export class BootServiceInstallError extends Schema.TaggedErrorClass<BootServiceInstallError>()(
  ...
  override get message(): string {
    return "Could not set up the Avi Code background service.";
  }
}
