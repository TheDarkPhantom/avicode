...
import { InterruptSuppressionLive } from "../src/orchestration/InterruptSuppression.ts";
...
import { ProposedPlanImplementationReactor } from "../src/orchestration/Services/ProposedPlanImplementationReactor.ts";
...
export const makeOrchestrationIntegrationHarness = (
  ...
  Effect.gen(function* () {
    ...
    const orchestrationReactorLayer = OrchestrationReactorLive.pipe(
      ...
      Layer.provideMerge(
        Layer.succeed(ProposedPlanImplementationReactor, {
          start: () => Effect.void,
          drain: Effect.void,
        }),
      ),
