...
export const GET_LEGACY_T3_IMPORT_STATUS_CHANNEL = "desktop:get-legacy-t3-import-status";
export const IMPORT_LEGACY_T3_DATA_CHANNEL = "desktop:import-legacy-t3-data";
