...
- The in-app browser now shows an error page for HTTP failures instead of a blank panel
- Recover from a 431 in the in-app browser with a Clear cookies and reload button
...
- Sidebar changes keep chat header actions and panel toggles aligned (#175)
...
- Composer usage shows calmer 5-hour and weekly values with reset details on hover (#167)
