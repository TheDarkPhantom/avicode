...
function resolveThreadAwarenessPhase(
  ...
  // Historical shells and providers that never materialize a turn can still
  // have no latestTurn. A live session at "ready"/"idle" with nothing pending
  // and nothing running is the remaining completion signal: the
