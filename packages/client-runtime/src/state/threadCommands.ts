...
import {
  ...
  type DiscardThreadProposedPlanInput,
  type ForkThreadInput,
  type InterruptThreadTurnInput,
  type RespondToThreadApprovalInput,
  type RespondToThreadUserInputInput,
  type RevertThreadCheckpointInput,
  type RestoreThreadProposedPlanInput,
...
export type {
  ...
  CreateThreadInput,
  DeleteThreadInput,
  DiscardThreadProposedPlanInput,
  ForkThreadInput,
  InterruptThreadTurnInput,
  RespondToThreadApprovalInput,
  RespondToThreadUserInputInput,
  RevertThreadCheckpointInput,
  RestoreThreadProposedPlanInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    discardProposedPlan: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:discard-proposed-plan",
      execute: (input: DiscardThreadProposedPlanInput) => discardThreadProposedPlan(input),
      scheduler,
      concurrency,
    }),
    restoreProposedPlan: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:restore-proposed-plan",
      execute: (input: RestoreThreadProposedPlanInput) => restoreThreadProposedPlan(input),
      scheduler,
      concurrency,
    }),
