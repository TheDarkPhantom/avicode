...
export const WS_METHODS = {
  ...
  projectsResolveFileFallback: "projects.resolveFileFallback",
  ...
  vcsScanCleanupCandidates: "vcs.scanCleanupCandidates",
  vcsExecuteCleanup: "vcs.executeCleanup",
  vcsRunWorktreeHealthCheck: "vcs.runWorktreeHealthCheck",
...
export const WsProjectsResolveFileFallbackRpc = Rpc.make(WS_METHODS.projectsResolveFileFallback, {
  payload: ProjectResolveFileFallbackInput,
  success: ProjectResolveFileFallbackResult,
  error: EnvironmentAuthorizationError,
});
...
// Avi Code addition: worktree cleanup
export const WsVcsScanCleanupRpc = Rpc.make(WS_METHODS.vcsScanCleanupCandidates, {
  payload: VcsScanCleanupInput,
  success: VcsScanCleanupResult,
  error: Schema.Union([GitCommandError, EnvironmentAuthorizationError]),
});

export const WsVcsExecuteCleanupRpc = Rpc.make(WS_METHODS.vcsExecuteCleanup, {
  payload: VcsExecuteCleanupInput,
  success: VcsExecuteCleanupResult,
  error: Schema.Union([GitCommandError, EnvironmentAuthorizationError]),
});

export const WsVcsRunWorktreeHealthCheckRpc = Rpc.make(WS_METHODS.vcsRunWorktreeHealthCheck, {
  payload: Schema.Struct({}),
  success: WorktreeHealthSnapshot,
  error: Schema.Union([GitCommandError, EnvironmentAuthorizationError]),
});
...
export const WsRpcGroup = RpcGroup.make(
  ...
  WsProjectsResolveFileFallbackRpc,
  ...
  WsVcsScanCleanupRpc,
  WsVcsExecuteCleanupRpc,
  WsVcsRunWorktreeHealthCheckRpc,
  WsVcsCreateRefRpc,
  WsVcsSwitchRefRpc,
  WsVcsInitRpc,
